...
/**
 * POST /api/promotions/campaign/delete
 * Body: { "campaignId": 123 }
 */
public class AdminPromotionDeleteHandler implements HttpHandler {
    @Override
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            e.printStackTrace();
            JsonResponseUtil.sendJson(exchange, 500, "{ \"error\": \"Failed to delete campaign\" }");
        }
    }
}
