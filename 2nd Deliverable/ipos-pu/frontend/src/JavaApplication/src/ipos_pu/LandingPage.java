...
/**
 Landing page for sign-in, registration, and guest access.
 *
 * @author nuhur
 */
public class LandingPage extends javax.swing.JFrame {
    ...
    /**
     Builds and styles the landing page layout and buttons.
     */
    ...
    /**
     Styles a primary or secondary button on the landing page.
     */
